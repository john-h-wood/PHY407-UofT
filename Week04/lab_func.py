...
def relative_error(experimental_value: Union[np.ndarray, float], true_value: Union[np.ndarray, float]) -> ArrayLike:
    ...
    """
    if np.isin(0, true_value):
        raise ZeroDivisionError('At least one true value is equal to zero.')
